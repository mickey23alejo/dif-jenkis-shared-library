              ...
              spec:
                ...
                - name: docker
                  ...
                  env: 
                    ...
                    - name: DOCKER_OPTS
                      value: --insecure-registry 10.100.43.10:8082
                - name: dind-daemon 
            ...
            stage('docker build') {
                ...
                steps {
                    container('docker'){
                            ...
                            sh "docker login -u admin --password n2oxM-poryD-ew92Y-a2tFn 10.100.43.10:8082"
                            sh "docker tag qa-'${config.name}'-image:v1.0.$BUILD_NUMBER 10.100.43.10:8082/qa-'${config.name}'-image:v1.0.$BUILD_NUMBER"
